...
{
    public class GroupFeesRepository : BaseRepository<GroupFees>, IGroupFeesRepository
    {
        public GroupFeesRepository(IqraQuranCenterDbContext dbContext) : base(dbContext)
        {
        }
    }
}
