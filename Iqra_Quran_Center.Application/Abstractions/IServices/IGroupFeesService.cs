...
{
    public interface IGroupFeesService
    {
        Task<APIResponse<int>> CreateGroupFee(GroupFeeRequest model);
        Task<APIResponse<int>> UpdateGroupFee(UpdateGroupFeeRequest model);
    }
}
